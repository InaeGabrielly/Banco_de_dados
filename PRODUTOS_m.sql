...
values (1,"Batata palha","","5.50","10",3,3),
 (2,"Toddynho","","5.00","15",3,2);

insert into Vendas (ID , DataDaVenda ,ValorTotal ,Funcionario)
 values (1,"2023-10-23","300.00","fulando de tal"),
...
-- QUESTAO 06
select V.ID AS IDVenda , V.DataDaVenda, IV.QuantidadeVendida, IV.PrecoUnitario
from Vendas V
INNER JOIN ItensDeVenda IV on V.ID = IV.IDDaVenda
